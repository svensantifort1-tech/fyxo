...
const packages = [
  {
    ...
    features: [
      ...
      "Responsive design",
      "SEO-geoptimaliseerd",
      "Google PageSpeed 90+/100eed 90+/100",
  ...
  },
  {
    ...
    description: "Volledig ontzorgd. Wij regelen hosting, updates en onderhoud zodat jouw seen Google PageSpeed score van 90/100 of hoger behouddsnel blijft.",
    badge: "Meest gekozen",
    features: [
      "Alles uit Standaard",
